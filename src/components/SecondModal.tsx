...
import { bmsemoji, irmap } from '@/assets';
    ...
    <div className="py-40  flex items-center justify-center">
      <Modal>
        <ModalTrigger className=" dark:text-white text-black flex justify-center group/modal-btn">
          <span className="group-hover/modal-btn:translate-x-40 text-center text-lg md:text-2xl bg-white  p-10  transition duration-200">
            طرح ملی
          </span>
          <div className="-translate-x-40 group-hover/modal-btn:translate-x-0 flex items-center justify-center absolute inset-0 transition duration-500 text-white z-20">
            <Image src={ irmap } alt="alt" width={ 40 } height={ 40 } />
          </div>
        </ModalTrigger>
        <ModalBody>
          <ModalContent>
